...
export default function AboutPage() {
  ...
  the World Health Organisation, UNICEF, and other local communities.
    ...
    <p><a>Home</a>/About</p>
      ...
      >
      <p>
        ICROSS is an equal opportunity employer. As part of our Gender policy, we have actively recruited women into senior management positions. The majority of project managers and field coordinators are women, and the great majority of field staff are women. ICROSS focuses all its core programme development on gender.
      </p>
      </Message>
      <Message
      title="Ownership"
      ...
      title="Whose Reality"
      >
        <p>As part of corporate accountability ICROSS places the beliefs, values, cultural structures and hopes of the local people at the centre of planning, decision making and planning. With a strong inclusion policy and partnership in local language, we work towards programmes that have their roots in local communities.</p>
      </Message>
      <Message
      title="Transparency"
      >    
  ...
  function Section1 ({src}) {
    ...
    return (
        ...
        <div className="about-group2">
            ...
            <p style={{marginBottom:'1rem'}}>ICROSS began its work among pastoral communities in East Africa in 1979. For over 37 years, we gradually extended the coverage of our work from central Kenya to vulnerable communities in the Western counties of Kenya, particularly in the areas of HIV/AIDS.</p>
